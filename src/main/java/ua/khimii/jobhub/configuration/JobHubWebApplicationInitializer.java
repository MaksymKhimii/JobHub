...
import ua.khimii.jobhub.filter.JobHubFilter;
import ua.khimii.jobhub.listener.ApplicationListener;


public class JobHubWebApplicationInitializer implements WebApplicationInitializer {
    ...
    private WebApplicationContext createWebApplicationContext(ServletContext container) {
        ...
        ctx.scan("ua.khimii.jobhub.configuration");
    ...
    private void registerFilters(ServletContext container, WebApplicationContext ctx) {
        registerFilter(container, ctx.getBean(JobHubFilter.class));
